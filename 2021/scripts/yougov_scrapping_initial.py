...
base_url_allensbach='https://www.wahlrecht.de/umfragen/yougov'
...
allensbach_concat.drop([58,59,60],axis=0, inplace=True)
...
allensbach_concat['INSTITUT']='YOUGOV'
...
allensbach_concat.to_csv('C:/Users/Lutz/Desktop/Data Science/Politics/cleaned_polls/yougov.csv', index=False)