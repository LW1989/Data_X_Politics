...
base_url_allensbach='https://www.wahlrecht.de/umfragen/insa'
...
allensbach_concat.drop([223,224,474,475,476,477],axis=0, inplace=True)
...
allensbach_concat['BEFRAGTE']=allensbach_concat['BEFRAGTE'].str.replace(r'O • ', '', regex=True).astype('float')

allensbach_concat['INSTITUT']='INSA'
...
allensbach_concat.to_csv('C:/Users/Lutz/Desktop/Data Science/Politics/cleaned_polls/insa.csv', index=False)