...
base_url_allensbach='https://www.wahlrecht.de/umfragen/politbarometer'
#range_list=list(range(1998,2008))
sub_url_years=['/politbarometer-1998', '/politbarometer-2002', '/politbarometer-2005', '/politbarometer-2009', '/politbarometer-2013', '/politbarometer-2017' ]
...
allensbach_concat.drop('PIRATEN',axis=1, inplace=True)
allensbach_concat.drop([167,245,325, 404,470],axis=0, inplace=True)
...
# allensbach_concat['DATUM']=pd.to_datetime(allensbach_concat['DATUM'], errors='ignore', format='%d.%m.%Y')
...
# allensbach_concat['INSTITUT']='POLITBAROMETER'
...
# allensbach_concat.to_csv('C:/Users/Lutz/Desktop/Data Science/Politics/cleaned_polls/politbarometer.csv', index=False)